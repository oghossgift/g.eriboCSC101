fn main() {
    ...
    println!("\nThe {} is informed by the aspiration to train electrical/electronic engineering professionals in the areas of design, building and maintainance of electrical control systems, ", n4);
